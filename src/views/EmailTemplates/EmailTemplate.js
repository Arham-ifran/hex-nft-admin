                            ...
                            <Col md="12">
                                <Card className="pb-3">
                                    <Card.Header>
                                        ...
                                        <p className="card-collection text-white">Note: Make sure you edit content using source &amp; don't edit keywords starting &amp; ending with $$ (e.g. $$USER$$) or special text inside x tag.</p>
                                    </Card.Header>
                                    <Card.Body>
                                        <Row>
                                            <Col md="6">
